...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "/FileUploaded/Upload";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("/FileUploaded/Upload");
        ...
        ResourceType type3;
        type3 = ResourceType.Add("VIDEO");
        type3.Url = BaseUrl + "/VIDEO/";
        type3.Dir = BaseDir == "" ? "" : BaseDir + "/VIDEO/";
        type3.MaxSize = 0;
        type3.AllowedExtensions = new string[] { "mp4", "MOV" };
        type3.DeniedExtensions = new string[] { };

        // Thư mục 2: Lưu tất cả các loại file
        ResourceType type4;
        type4 = ResourceType.Add("AUDIO");
        type4.Url = BaseUrl + "/AUDIO/";
        type4.Dir = BaseDir == "" ? "" : BaseDir + "/AUDIO/";
        type4.MaxSize = 0;
        type4.AllowedExtensions = new string[] { "mp3" };
        type4.DeniedExtensions = new string[] { };
