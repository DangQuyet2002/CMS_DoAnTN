$(function () {
    ...
    document.getElementById("topnav-hamburger-icon").replaceWith(document.getElementById("topnav-hamburger-icon").cloneNode(true));
    ...
    function f() {
        var o, e, t = document.documentElement.getAttribute("data-layout"),
            ...
            a = JSON.parse(a);
        !a || "twocolumn" != t && "twocolumn" != a["data-layout"] || (document.querySelector(".navbar-menu").innerHTML = m, (o = document.createElement("ul")).innerHTML = '<a href="#" className="logo"><img src="assets/images/logo-sm.png" alt="" height="22"></a>', document.getElementById("navbar-nav").querySelectorAll(".menu-link").forEach(function (e) {
    ...
    function w(e) {
        ...
        if (e.target && e.target.matches("a.nav-link"))
            if (0 == p(e.target.nextElementSibling)) e.target.nextElementSibling.classList.add("dropdown-custom-right"), e.target.parentElement.parentElement.parentElement.classList.add("dropdown-custom-right"), e.target.nextElementSibling.querySelectorAll(".menu-dropdown").forEach(function (e) {
                e.classList.add("dropdown-custom-right")
            });
    ...
    sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-layout-mode"] = sessionStorage.getItem("data-layout-mode"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), q(a)) : (i = [...document.documentElement.attributes], a = {}, i.forEach(function (e) {
        ...
        //sessionStorage.setItem("defaultAttribute", JSON.stringify(a)), q(a), (i = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && i.click()), 

        f(),

        t = document.getElementById("search-close-options"), o = document.getElementById("search-dropdown"),

        (n = document.getElementById("search-options")) && (n.addEventListener("focus", function () {
        ...
        s = document.getElementById("search-close-options"), d = document.getElementById("search-dropdown-reponsive"), e = document.getElementById("search-options-reponsive"),

        s && d && e && (e.addEventListener("focus", function () {
        ...
        document.addEventListener("fullscreenchange", N), document.addEventListener("webkitfullscreenchange", N), document.addEventListener("mozfullscreenchange", N), l = document.getElementsByTagName("HTML")[0],
        ...
        k(),
        // v(), 
        document.getElementsByClassName("dropdown-item-cart") && (r = document.querySelectorAll(".dropdown-item-cart").length, document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn").forEach(function (e) {
            e.addEventListener("click", function (e) {
            ...
            e.innerHTML = r
        }), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = "block"), H()),
