...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class QuanLyAudioDaXoaController : Controller
    {
        private readonly IThungRacVaLogService _ThungRacVaLogService;
        private readonly IQuanLyDanhMucService _QuanLyDanhMucService;

        public QuanLyAudioDaXoaController(IThungRacVaLogService ThungRacVaLogService, IQuanLyDanhMucService QuanLyDanhMucService)
        {
        ...
        [HttpPost]
        public async Task<JsonResult> DanhSachAudioXoa(tbl_ThuVienAudioModel model)
        {
            try
            {
                BaseRespone<tbl_ThuVienAudioModel> response = await _ThungRacVaLogService.DanhSachAudioXoa(model);
                return Json(new
                {
        ...
        public async Task<JsonResult> KhoiPhucAudio(tbl_ThuVienAudioModel requestModel)
        {
            ...
            try
            {
                ...
                Response check = await _ThungRacVaLogService.KhoiPhucAudio(requestModel);
