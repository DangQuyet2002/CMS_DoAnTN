...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class QuanLyAudioController : Controller
    {
        ...
        public QuanLyAudioController(IQuanLyAudioService QuanLyAudioService, IQuanLyDanhMucService QuanLyDanhMucService)
        {
        ...
        [HttpPost]
        public async Task<JsonResult> DanhSach(tbl_ThuVienAudioModel model)
        {
            try
            {
                BaseRespone<tbl_ThuVienAudioModel> response = await _QuanLyAudioService.DanhSach(model);
                return Json(new
                {
        ...
        public async Task<JsonResult> ThemMoi(tbl_ThuVienAudioModel requestModel)
        {
            ...
            try
            {
                ...
                Response check = await _QuanLyAudioService.ThemMoi(requestModel);
        ...
        [HttpPost, ValidateInput(false)]
        public async Task<JsonResult> CapNhat(tbl_ThuVienAudioModel requestModel)
        {
            ...
            try
            {
                ...
                JsonResponse message = new JsonResponse();
                Response check = await _QuanLyAudioService.CapNhat(requestModel);
                if (check.code == ResponseCode.SUCCESS)
                {
        ...
        [HttpPost, ValidateInput(false)]
        public async Task<JsonResult> Xoa(tbl_ThuVienAudioModel requestModel)
        {
            ...
            try
            {
                ...
                JsonResponse message = new JsonResponse();
                Response check = await _QuanLyAudioService.Xoa(requestModel);
                if (check.code == ResponseCode.SUCCESS)
                {
