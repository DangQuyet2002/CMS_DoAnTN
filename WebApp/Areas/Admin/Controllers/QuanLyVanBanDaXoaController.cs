...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class QuanLyVanBanDaXoaController : Controller
    {
        private readonly IThungRacVaLogService _ThungRacVaLogService;
        private readonly IQuanLyDanhMucService _QuanLyDanhMucService;

        public QuanLyVanBanDaXoaController(IThungRacVaLogService ThungRacVaLogService, IQuanLyDanhMucService QuanLyDanhMucService)
        {
        ...
        [HttpPost]
        public async Task<JsonResult> DanhSachVanBanXoa(tbl_VanBanModel model)
        {
            try
            {
                BaseRespone<tbl_VanBanModel> response = await _ThungRacVaLogService.DanhSachVanBanXoa(model);
                return Json(new
                {
        ...
        public async Task<JsonResult> KhoiPhucVanBan(tbl_VanBanModel requestModel)
        {
            ...
            try
            {
                ...
                Response check = await _ThungRacVaLogService.KhoiPhucVanBan(requestModel);
