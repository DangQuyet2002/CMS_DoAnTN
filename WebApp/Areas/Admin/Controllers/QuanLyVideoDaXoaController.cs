...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class QuanLyVideoDaXoaController : Controller
    {
        ...
        [HttpPost]
        public async Task<JsonResult> DanhSachVideoXoa(tbl_ThuVienVideoModel model)
        {
            try
            {
                BaseRespone<tbl_ThuVienVideoModel> response = await _ThungRacVaLogService.DanhSachVideoXoa(model);
                return Json(new
                {
        ...
        public async Task<JsonResult> KhoiPhucVideo(tbl_ThuVienVideoModel requestModel)
        {
            ...
            try
            {
                ...
                Response check = await _ThungRacVaLogService.KhoiPhucVideo(requestModel);
