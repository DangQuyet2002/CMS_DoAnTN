...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class DanhSachTinMoiController : Controller
    {
        ...
        public async Task<JsonResult> CapNhatTinTucMoi(tbl_PostModel requestModel)
        {
            ...
            try
            {
                ...
                Response check = await _QuanLyBaiDangService.TinTucMoi(requestModel);
